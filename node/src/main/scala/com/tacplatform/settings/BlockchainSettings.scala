...
case class FunctionalitySettings(
    ...
    minBlockTime: FiniteDuration = 10.seconds,
    delayDelta: Int = 8
) {
...
object GenesisSettings { // TODO: Move to network-defaults.conf
  val MAINNET = GenesisSettings(
    ...
    1633591229960L,
    20000000000000L,
    ByteStr.decodeBase58("qdrezszZziQ22TR8Ye8rm5JkVW4A8DvgYMUnWtVbB6pAbQjwYzgrLJFQtofV3BSCK4tZpf79j92463PPWcYdLvp").toOption,
    List(
      GenesisTransactionSettings("Tu8n5bRGxPGiTNhhoQ7zG9RwhAeNoJCHmEb", 20000000000000L),
